...
describe("#core - main", function() {
    it("basic operation on test/fixtures/cjs", function() {
        var lActualDepLines = core.getDependencyStrings("test/fixtures/cjs", {delimiter:"# DO NOT DELETE THIS LINE", system:["amd", "cjs", "es6"]});
    ...
    it("basic operation on test/fixtures/cjs/root_two.js", function() {
        var lActualDepLines = core.getDependencyStrings("test/fixtures/cjs/root_two.js", {delimiter:"# DO NOT DELETE THIS LINE", system:["amd", "cjs", "es6"]});
        var lExpectedDepLines = [
             "\n# DO NOT DELETE THIS LINE\n\n",
             "# amd dependencies\n",
             "",
